...
(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var KuiContext = /*#__PURE__*/React.createContext({
    theme: defaultThemes
  });
  ...
  var ButtonProvider = function ButtonProvider(_ref) {
    ...
    var globalTheme = React.useContext(KuiContext);
  ...
  var DefaultButton = function DefaultButton(_a) {
    ...
    }, /*#__PURE__*/React.createElement(Wrap$4, _extends({
      "$pending": !!loading
    }, props), loading ? /*#__PURE__*/React.createElement(SvgLoading, null) : props.children));
  };
  var Button = function Button(_a) {
    var children = _a.children,
      props = __rest(_a, ["children"]);
    return /*#__PURE__*/React.createElement(DefaultButton, _extends({}, props), children);
  };
  ...
  */
  ...
  var DefaultCalendar = function DefaultCalendar(_a) {
    ...
    return /*#__PURE__*/React.createElement(CalendarProvider, {
      customTheme: customTheme
    }, /*#__PURE__*/React.createElement(Wrap$3, _extends({
      "$css": $css
    }, props), /*#__PURE__*/React.createElement(WeeksRow, {
      className: "weeks-row"
    }, /*#__PURE__*/React.createElement(WeekColumn, {
      className: "week"
    }, "\uC77C"), /*#__PURE__*/React.createElement(WeekColumn, {
      className: "week"
    }, "\uC6D4"), /*#__PURE__*/React.createElement(WeekColumn, {
      className: "week"
    }, "\uD654"), /*#__PURE__*/React.createElement(WeekColumn, {
      className: "week"
    }, "\uC218"), /*#__PURE__*/React.createElement(WeekColumn, {
      className: "week"
    }, "\uBAA9"), /*#__PURE__*/React.createElement(WeekColumn, {
      className: "week"
    }, "\uAE08"), /*#__PURE__*/React.createElement(WeekColumn, {
      className: "week"
    }, "\uD1A0")), calendarData && calendarData.map(function (week, index) {
      return /*#__PURE__*/React.createElement(DaysRow, {
        key: 'week' + index,
        className: "days-row"
        ...
        }, /*#__PURE__*/React.createElement(DayPart, {
          className: "day"
        }, /*#__PURE__*/React.createElement("div", {
          className: "day-part",
          "data-date": day.current.format('YYYY-MM-DD')
        }, /*#__PURE__*/React.createElement("span", null, day.current.format('D')))));
      }));
    })));
  };
  var Calendar = function Calendar(props) {
    return /*#__PURE__*/React.createElement(DefaultCalendar, _extends({}, props));
  };
  ...
  var CodeBlock = function CodeBlock(_a) {
    ...
    return /*#__PURE__*/React.createElement(Wrap$2, _extends({
      "$css": $css
    }, props), /*#__PURE__*/React.createElement(Title, null, /*#__PURE__*/React.createElement(FileName, null, /*#__PURE__*/React.createElement(SvgTs, null), title), /*#__PURE__*/React.createElement("div", null, copyStatus ? /*#__PURE__*/React.createElement(Clipboard, {
      className: "copy-check-icon"
    }, /*#__PURE__*/React.createElement(SvgCopyCheck, null), /*#__PURE__*/React.createElement("span", null, "Copied !")) : /*#__PURE__*/React.createElement(Clipboard, {
      tabIndex: 0,
      className: "copy-icon",
      onClick: function onClick() {
    ...
    }, /*#__PURE__*/React.createElement(SvgCopy, null), /*#__PURE__*/React.createElement("span", null, "Copy")))), /*#__PURE__*/React.createElement(reactSyntaxHighlighter.Prism, {
  ...
  var useTheme = function useTheme(_ref) {
    ...
    var _React$useState = React.useState(theme ? merge$1(defaultThemes, theme) : defaultThemes),
      _React$useState2 = _slicedToArray(_React$useState, 2),
  ...
  var KuiProvider = function KuiProvider(_ref2) {
    ...
    return /*#__PURE__*/React.createElement(KuiContext.Provider, {
      value: currentTheme
    }, children);
  };
  ...
  var DefaultDropdown = function DefaultDropdown(_a) {
    ...
    var valueKey = React.useMemo(function () {
      if (selectedItem) {
        return Object.keys(selectedItem)[0];
      }
      return null;
    }, [selectedItem]);
    var labelString = React.useMemo(function () {
    ...
    var getCurrentList = React.useCallback(function () {
    ...
    var memorizedRef = React.useRef(null);
    ...
    return /*#__PURE__*/React.createElement(DropdownProvider, {
      customTheme: customTheme
    }, /*#__PURE__*/React.createElement(Wrap$1, _extends({
      ref: wrapRef,
      "$css": $css,
      "$width": $width
    }, props), minWidth === 0 && !$width && /*#__PURE__*/React.createElement(List, {
      ref: memorizedRef
    ...
    }), /*#__PURE__*/React.createElement("div", null, init ? labelString !== null && labelString !== void 0 ? labelString : placeholder : ''), /*#__PURE__*/React.createElement(SvgCaretDown, {
      width: 18,
      height: 18
    })), currentList && /*#__PURE__*/React.createElement(List, {
      className: classNames({
        focus: focus
      })
  ...
  var Dropdown = function Dropdown(props) {
    return /*#__PURE__*/React.createElement(DefaultDropdown, _extends({}, props));
  };
  ...
  var DefaultLineChart = function DefaultLineChart(_a) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(LineChartWrap, _extends({
      ref: chartWrapRef,
      "$css": $css,
      className: classNames({
    ...
    }, props), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(SvgChartWrap, null, isNoData && /*#__PURE__*/React.createElement(Nodata, {
      className: classNames({
        disableY: XChartType === '주간',
        scrolledX: XChartType === '월간'
      })
    }, /*#__PURE__*/React.createElement("div", null, "\uB4F1\uB85D\uB41C \uB370\uC774\uD130\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4.")), !isNoData && /*#__PURE__*/React.createElement("svg", {
      width: Y_AXIS_WIDTH,
      ...
      var _a;
      return /*#__PURE__*/React.createElement(YText, {
      ...
      var _a;
      return /*#__PURE__*/React.createElement(XText, {
        className: "x-axis",
      ...
      strokeWidth: 1
    }), yAverage && /*#__PURE__*/React.createElement("path", {
      ...
      fill: "transparent",
      strokeWidth: 1
    }), lineGraphData && lineGraphData.chartValues.extraData && /*#__PURE__*/React.createElement(React.Fragment, null, lineGraphData.chartValues.extraData.map(function (extra, extraIndex) {
    ...
    })), lineGraphData && (lineGraphData === null || lineGraphData === void 0 ? void 0 : lineGraphData.chartValues.chartPoint.length) > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("path", {
      className: "line",
    ...
    })))))), /*#__PURE__*/React.createElement(BottomInfoWrap, _extends({
      className: classNames({
    ...
    }), /*#__PURE__*/React.createElement(LineInfoWrap, null, /*#__PURE__*/React.createElement("div", null, "\uD3C9\uADE0 :"), /*#__PURE__*/React.createElement("div", {
      className: "line",
      style: {
        backgroundColor: nextTheme === null || nextTheme === void 0 ? void 0 : nextTheme.color.averageLineColor
      }
    })), lineGraphData && lineGraphData.chartValues.extraData && /*#__PURE__*/React.createElement(React.Fragment, null, lineGraphData.chartValues.extraData.map(function (extra, extraIndex) {
      return /*#__PURE__*/React.createElement(LineInfoWrap, {
        key: 'extraInfo' + extraIndex
      }, /*#__PURE__*/React.createElement("div", null, extra.title, " :"), /*#__PURE__*/React.createElement("div", {
        className: "line",
        style: {
  ...
  var LineChart = function LineChart(props) {
    return /*#__PURE__*/React.createElement(LineChartProvider, {
      customTheme: props.customTheme
    }, /*#__PURE__*/React.createElement(DefaultLineChart, _extends({}, props)));
  };
  ...
  var TextInputProvider = function TextInputProvider(_ref) {
    var children = _ref.children,
      customTheme = _ref.customTheme;
    var globalTheme = React.useContext(KuiContext);
    var defaultTextInputTheme = React.useMemo(function () {
  ...
  var DefaultTextInput = function DefaultTextInput(_a) {
    ...
    return /*#__PURE__*/React.createElement(TextInputProvider, {
      customTheme: customTheme
      ...
      "$css": $wrapCss,
      "$radius": $radius
    }, wrapProps), prepend, /*#__PURE__*/React.createElement(Input, _extends({
      ref: inputRef,
      ...
      "$inputStyle": inputStyle
    }, props)), append, !disableRemoveButton && /*#__PURE__*/React.createElement("button", {
    ...
    }, valued && /*#__PURE__*/React.createElement(SvgDeleteInput, null))));
  };
  var BoxInput = function BoxInput(props) {
    return /*#__PURE__*/React.createElement(DefaultTextInput, _extends({
      inputStyle: "box"
    }, props));
  };
