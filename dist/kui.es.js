...
var KuiContext = /*#__PURE__*/React__default.createContext({
  theme: defaultThemes
});
...
var CodeBlock = function CodeBlock(_a) {
  ...
  return /*#__PURE__*/React__default.createElement(Wrap$2, _extends({
    "$css": $css
  }, props), /*#__PURE__*/React__default.createElement(Title, null, /*#__PURE__*/React__default.createElement(FileName, null, /*#__PURE__*/React__default.createElement(SvgTs, null), title), /*#__PURE__*/React__default.createElement("div", null, copyStatus ? /*#__PURE__*/React__default.createElement(Clipboard, {
    className: "copy-check-icon"
  }, /*#__PURE__*/React__default.createElement(SvgCopyCheck, null), /*#__PURE__*/React__default.createElement("span", null, "Copied !")) : /*#__PURE__*/React__default.createElement(Clipboard, {
    tabIndex: 0,
    className: "copy-icon",
    onClick: function onClick() {
  ...
  }, /*#__PURE__*/React__default.createElement(SvgCopy, null), /*#__PURE__*/React__default.createElement("span", null, "Copy")))), /*#__PURE__*/React__default.createElement(Prism, {
...
var useTheme = function useTheme(_ref) {
  ...
  var _React$useState = React__default.useState(theme ? merge$1(defaultThemes, theme) : defaultThemes),
    _React$useState2 = _slicedToArray(_React$useState, 2),
...
var KuiProvider = function KuiProvider(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(KuiContext.Provider, {
    value: currentTheme
  }, children);
};
...
var DefaultDropdown = function DefaultDropdown(_a) {
  ...
  var valueKey = React__default.useMemo(function () {
    if (selectedItem) {
      return Object.keys(selectedItem)[0];
    }
    return null;
  }, [selectedItem]);
  var labelString = React__default.useMemo(function () {
  ...
  var _React$useState11 = React__default.useState(null),
    _React$useState12 = _slicedToArray(_React$useState11, 2),
    currentList = _React$useState12[0],
    set_currentList = _React$useState12[1];
  var getCurrentList = React__default.useCallback(function () {
  ...
  var memorizedRef = React__default.useRef(null);
  var labelRef = React__default.useRef(null);
  var wrapRef = React__default.useRef(null);
  ...
  return /*#__PURE__*/React__default.createElement(DropdownProvider, {
    customTheme: customTheme
  }, /*#__PURE__*/React__default.createElement(Wrap$1, _extends({
    ref: wrapRef,
    "$css": $css,
    "$width": $width
  }, props), minWidth === 0 && !$width && /*#__PURE__*/React__default.createElement(List, {
    ref: memorizedRef
  ...
  }), /*#__PURE__*/React__default.createElement("div", null, init ? labelString !== null && labelString !== void 0 ? labelString : placeholder : ''), /*#__PURE__*/React__default.createElement(SvgCaretDown, {
    width: 18,
    height: 18
  })), currentList && /*#__PURE__*/React__default.createElement(List, {
    className: classNames({
      focus: focus
    })
...
var getInputStyle = function getInputStyle(props, styleType) {
  var color = props.color,
    textStyle = props.textStyle;
  var InputStyleCSS = {
    default: css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n      appearance: none;\n      border: none;\n      outline: none;\n      width: 100%;\n      background-color: transparent;\n      color: inherit;\n      ", "\n    "])), textStyle.default),
    box: css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n      appearance: none;\n      border: none;\n      outline: none;\n      background-color: transparent;\n      width: 100%;\n      padding: 8px 0;\n      color: ", ";\n      ", "\n      &::placeholder {\n        color: ", ";\n      }\n      &:disabled {\n        color: ", ";\n      }\n    "])), color.box.textColor, textStyle.default, color.box.placeholderColor, color.box.textDisabledColor),
    underline: css(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n      appearance: none;\n      border: none;\n      outline: none;\n      background-color: transparent;\n      width: 100%;\n      padding: 8px 0;\n      color: ", ";\n      ", "\n      &::placeholder {\n        color: ", ";\n      }\n      &:disabled {\n        color: ", ";\n      }\n    "])), color.underline.textColor, textStyle.default, color.underline.placeholderColor, color.underline.textDisabledColor)
  };
  return InputStyleCSS[styleType];
};
var TextInputStyle = {
  Wrap: styled.div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n    ", ";\n  "])), function (_ref) {
    var theme = _ref.theme,
      $css = _ref.$css,
  ...
  Input: styled.input(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n    ", "\n  "])), function (_ref2) {
...
var DefaultTextInput = function DefaultTextInput(_a) {
  ...
  return /*#__PURE__*/React__default.createElement(TextInputProvider, {
    customTheme: customTheme
  }, /*#__PURE__*/React__default.createElement(Wrap, _extends({
    className: classNames({
    ...
    "$css": $wrapCss,
    "$radius": $radius
  }, wrapProps), prepend, /*#__PURE__*/React__default.createElement(Input, _extends({
    ref: inputRef,
    ...
    "$inputStyle": inputStyle
  }, props)), append, !disableRemoveButton && /*#__PURE__*/React__default.createElement("button", {
  ...
  }, valued && /*#__PURE__*/React__default.createElement(SvgDeleteInput, null))));
};
var BoxInput = function BoxInput(props) {
  return /*#__PURE__*/React__default.createElement(DefaultTextInput, _extends({
    inputStyle: "box"
  }, props));
};
